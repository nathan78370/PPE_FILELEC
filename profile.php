...
$stmt = $con->prepare('SELECT password, email, adresse, telephone, CodePOSTAL, Ville FROM accounts WHERE id = ?');
$stmt->bind_param('i', $_SESSION['id']);
$stmt->execute();
$stmt->bind_result($password, $email, $adresse, $telephone, $CodePOSTAL, $Ville);
$stmt->fetch();
$stmt->close();
?>
<!DOCTYPE html>
